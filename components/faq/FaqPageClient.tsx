      ...
      <section className="relative pt-32 pb-24 bg-navy overflow-hidden text-white">
        ...
        <div className="page-padding relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto">
          <FadeInOnScroll direction="up" className="flex flex-col items-center text-center">
            ...
            <h1 className="text-4xl md:text-[56px] font-heading font-normal text-white leading-tight mb-6 animate-fadeIn">
              Frequently asked <span className="text-gold">questions.</span>
            </h1>
            <p className="text-white/60 text-base leading-relaxed max-w-xl mb-4 font-light animate-fadeIn">
